    ...
    <section className="flex justify-wrap items-center 
      ...
      <div className="flex flex-1 flex-col">
        <h2 className="font-palanquin text-4xl capitalize   
                    max-sm:text-[72px] max-sm:leading-[82] font-bold lg:max-w-lg">
        ...
        <p className="mt-6 lg:max-w-lg info-text">
          Navigate a realm of possibilies designed to fulfill your unique desires,
          surpassing the loftiest expectations. Your journey with us is nothing sort of
          exceptional.
        </p>
